...
class lstm_cell : public cell {
 public:
   ...
   * @param params [in] optional lstm cell parameters
   **/
  ...
  inline std::vector<vector_type> output_order() {
    return {vector_type::data,  // output vector
            ...
            vector_type::aux,   // aux state  pre_i(t)
            vector_type::aux,   // aux state  pre_f(t)
            vector_type::aux,   // aux state  pre_z(t)
            vector_type::aux,   // aux state  pre_o(t)
            vector_type::aux,   // aux state  post_i(t)
            vector_type::aux,   // aux state  post_f(t)
            vector_type::aux,   // aux state  post_z(t)
            vector_type::aux};  // aux state  post_c(t)
  }
  ...
  inline std::vector<index3d<size_t>> out_shape() const {
    return {index3d<size_t>(params_.out_size_, 1, 1),   // o(t)
            ...
            index3d<size_t>(params_.out_size_, 1, 1),   // pre_i(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // pre_f(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // pre_z(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // pre_o(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // post_i(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // post_f(t)
            index3d<size_t>(params_.out_size_, 1, 1),   // post_z(t)
            index3d<size_t>(params_.out_size_, 1, 1)};  // post_c(t)
  }
